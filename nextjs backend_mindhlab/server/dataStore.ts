...
export const COLLABORATORS_FILE = path.join(DATA_DIR, "collaborators.json");
export const PUBLICATIONS_FILE = path.join(DATA_DIR, "publications.json");
export const FACILITIES_FILE = path.join(DATA_DIR, "facilities.json");
...
export const INITIAL_NEWS: LabNewsItem[] = [
  {
    id: "news-1",
    title: "Paper on Contactless rPPG Accepted to Nature Digital Medicine",
    description:
      "Our prospective clinical trial evaluating video-based vital sign extraction across 120 ICU beds has been accepted for publication. Demonstrating sub-1.5 BPM mean absolute error without physical skin contact under varied ambient hospital lighting conditions.",
    summary:
      "Our clinical trial evaluating video-based vital sign extraction in 120 ICU beds has been accepted for publication.",
    image:
  ...
  },
  {
    ...
    description:
      "Commenced prospective hospital deployment of our edge-AI hemodynamic warning system across surgical step-down wards, processing real-time bedside telemetry streams with sub-16ms latency.",
    summary:
      "Commenced prospective hospital deployment of our edge-AI hemodynamic warning system across surgical step-down wards.",
    image:
  ...
  },
  {
    ...
    description:
      "A 4-year multi-center investigation into multimodal optical and bioimpedance sensor fusion for ambulatory cardiovascular assessment and non-invasive continuous arterial blood pressure monitoring.",
    summary:
      "A 4-year multi-center investigation into multimodal optical and bioimpedance sensor fusion for ambulatory cardiovascular assessment.",
    image:
  ...
  },
  {
    ...
    description:
      "Prof. David Patel presented our laboratory's benchmark findings on self-supervised foundation models trained on continuous multi-lead ECG and photoplethysmography streams.",
    summary:
      "Keynote presentation at IEEE Engineering in Medicine and Biology Society on wearable physiological monitoring.",
    image:
...
export const INITIAL_TEAM: TeamMember[] = [
  {
    ...
    projects: [
      {
        title: "Contactless Multi-Spectral ICU Vital Sensing (NIH R01)",
        status: "Active",
        description:
          "Multi-center clinical trial deploying 4K chromatic sensors for zero-contact pediatric and ICU patient telemetry.",
      },
      {
        title: "Continuous Cuffless Arterial Pressure Monitoring",
        status: "Active",
        description:
          "Sensor fusion of optical photoplethysmography and bio-impedance for ambulatory hypertension tracking.",
      },
      {
        title: "Self-Supervised ECG Foundation Model (CardioState-10M)",
        status: "Completed",
        description:
          "Trained on 10 million hours of continuous telemetry to predict arrhythmia onset 4 hours in advance.",
      },
    ],
    publications: [
      {
        title:
          "Prospective Multi-Center Trial of Contactless Video Photoplethysmography in Critically Ill Adults",
        year: 2024,
        journalOrConference: "Nature Digital Medicine",
        doi: "10.1038/s41746-024-01120-x",
        link: "https://nature.com",
      },
      {
        title:
          "Foundations of Bedside Computational Physiology: Self-Supervised Waveform Representation",
        year: 2023,
        journalOrConference: "IEEE Trans. Biomedical Engineering",
        doi: "10.1109/TBME.2023.3289012",
      },
      {
        title:
          "Real-Time Hemodynamic Decompensation Warning Using Multimodal Deep Attention",
        year: 2022,
        journalOrConference: "Lancet Digital Health",
        doi: "10.1016/S2589-7500(22)00145-8",
      },
    ],
    awards: [
      {
      ...
      {
        title: "IEEE EMBC Outstanding Clinical Engineering Paper",
        year: "2021",
        organization: "IEEE Engineering in Medicine & Biology",
      },
    ],
    avatarUrl:
    ...
    linkedinUrl:
      "https://www.linkedin.com/company/medical-informatics-and-digital-health-lab/",
  ...
  },
  {
    ...
    skills: [
      "PyTorch / JAX",
      "OpenCV",
      "Chrominance Physics Models",
      "Optical Flow Estimation",
      "Real-Time C++ Video Pipelines",
    ],
    contributions: [
      "Created the ChromPhys benchmark containing 500+ hours of synchronized ground-truth clinical video.",
      "Designed motion-compensated face and palm tracker maintaining SNR during pediatric agitation.",
      "Holder of 2 US patents on contactless vital sign extraction under non-stationary lighting.",
    ],
    projects: [
      {
        title: "Deep Chromatic Diffusion for Contactless SpO2",
        status: "Active",
        description:
          "Multi-wavelength reflectance estimation overcoming skin pigmentation bias in contactless pulse oximetry.",
      },
      {
        title: "Microcirculation Perfusion Index Video Mapping",
        status: "Completed",
        description:
          "High-speed 120fps mapping of localized peripheral perfusion changes during septic shock models.",
      },
    ],
    publications: [
      {
        title: "Illumination-Invariant Neural Photoplethysmography with Spatio-Temporal Attention",
        year: 2024,
        journalOrConference: "IEEE CVPR (Healthcare Vision)",
        doi: "10.1109/CVPR.2024.08912",
      },
      {
        title: "Mitigating Pigmentation Bias in Non-Contact Oxygen Saturation Estimation",
        year: 2023,
        journalOrConference: "Nature Digital Medicine",
        doi: "10.1038/s41746-023-00914-1",
      },
    ],
    awards: [
      {
        title: "MIT Technology Review 35 Under 35 Honoree",
        year: "2023",
  ...
  },
  {
    ...
    detailedBio:
      "Dr. Rohan Sharma joined MINDH in 2023 following doctoral research on ultra-low-power biomedical micro-instrumentation. His work focuses on wearable sensor fusion—coupling high-frequency bio-impedance plethysmography with miniaturized reflective PPG.",
    labRoleDetail:
      "Leads wearable hardware prototyping, microcontroller firmware design, and benchtop artifact simulation.",
    focus: [
    ...
    projects: [
      {
        title: "Ambulatory 24h Cuffless BP Patch",
        status: "Active",
        description:
          "Clinical trial assessing 24-hour ambulatory blood pressure monitoring compared to A-line ground truth in CCU.",
      },
    ],
    publications: [
      {
        title: "Nonlinear Pulse Wave Transit Time Calibration for Ambulatory Blood Pressure",
        year: 2024,
        journalOrConference: "IEEE Trans. Biomedical Circuits & Systems",
        doi: "10.1109/TBCAS.2024.33120",
      },
    ],
    avatarUrl:
  ...
  },
  {
    ...
    detailedBio:
      "Kevin Zhao is a 4th-year PhD candidate co-advised by Prof. Patel and the Department of Computer Science. His dissertation investigates foundational representations of high-dimensional multi-lead electrophysiological time-series data.",
    labRoleDetail:
      "Maintains the lab's GPU cluster compute pipeline and leads transformer model development.",
    focus: [
      "Foundation Models for ECG",
    ...
    projects: [
      {
        title: "CardioState: Continuous Latent Space Representation",
        status: "Active",
        description: "Multi-channel masked autoencoding on 12-lead ECG telemetry.",
      },
    ],
    publications: [
      {
        title: "Self-Supervised Contrastive Learning Across Heterogeneous Physiological Waveforms",
        year: 2023,
        journalOrConference: "NeurIPS Workshop on Machine Learning for Health (ML4H)",
  ...
  },
  {
    ...
    detailedBio:
      "Maya Lin is a master's graduate researcher conducting experiments in the MINDH Prosodic & Affect Chamber. Her research investigates how acoustic micro-variations correlate with diaphragmatic fatigue.",
    labRoleDetail:
      "Coordinates human participant testing in the acoustic chamber and oversees audio feature engineering.",
    focus: [
      "Vocal Biomarkers",
    ...
    projects: [
      {
        title: "Vocal Prosody for Pulmonary Exacerbation Detection",
        status: "Active",
        description:
          "Mobile microphone acoustic analysis for outpatient chronic lung disease flare-up triage.",
      },
    ],
    publications: [
      {
        title: "Acoustic Glottal Features as Proxies for Minute Ventilation During Physical Exertion",
        year: 2024,
        journalOrConference: "Interspeech (Bio-Acoustics Session)",
        doi: "10.21437/Interspeech.2024-1182",
      },
    ],
    avatarUrl:
  ...
  },
  {
    ...
    detailedBio:
      "Dr. Marcus Thorne was a postdoctoral fellow in the MINDH Lab from 2020 to 2023. He is now a tenure-track Assistant Professor of Biomedical Engineering at Johns Hopkins University.",
    ...
    projects: [
      {
        title: "Clinician Interpretability & Alert Fatigue Mitigation",
        status: "Completed",
        description:
          "Bedside trial measuring provider trust calibration under conflicting model recommendations.",
      },
    ],
    publications: [
      {
        title: "Concept Bottleneck Models Reduce Clinician Automation Bias in Critical Care",
        year: 2023,
        journalOrConference: "Nature Machine Intelligence",
        doi: "10.1038/s42256-023-00712-4",
      },
    ],
    avatarUrl:
  ...
  },
  {
    ...
    detailedBio:
      "Dr. Sarah Al-Mansoor is an attending critical care physician and clinical co-investigator with the MINDH Lab. She directs the medical intensive care unit where our contactless optical monitoring and hemodynamic early-warning systems are clinically piloted.",
    labRoleDetail:
      "Principal clinical collaborator; leads institutional review board (IRB) protocols and clinical ground truth adjudication.",
    focus: ["Critical Care Medicine", "Sepsis Phenotyping", "Bedside Usability", "Clinical Trial Oversight"],
    skills: [
      "Critical Care Hemodynamics",
      "ICU Bedside Telemetry",
      "IRB Clinical Protocol Design",
      "EHR Chart Abstraction",
    ],
    contributions: [
    ...
    projects: [
      {
        title: "Prospective Sepsis Decompensation Alerting Trial",
        status: "Active",
        description: "Randomized controlled trial evaluating early bedside notification response times.",
      },
    ],
    publications: [
      {
        title: "Impact of Continuous Bedside Physiological AI on Nursing Alert Response Times",
        year: 2024,
        journalOrConference: "Critical Care Medicine",
        doi: "10.1097/CCM.0000000000006240",
      },
    ],
    avatarUrl:
      "https://images.unsplash.com/photo-1594824813571-638f02614d3f?auto=format&fit=crop&q=80&w=600",
...
export const INITIAL_COLLABORATORS: Collaborator[] = [
  {
    ...
    keyContacts: [
      "Dr. Sarah Al-Mansoor, MD (ICU Director)",
      "Prof. Robert Lang, MD (Pulmonary Medicine)",
    ],
    activeTrials: [
  ...
  },
  {
    ...
    keyContacts: [
      "Dr. Marcus Thorne, PhD (Assistant Professor)",
      "Prof. Elena Rostova, MD, PhD",
    ],
    activeTrials: [
  ...
  },
  {
    ...
    keyContacts: [
      "Prof. David K. Patel, MD, PhD (Adjunct Investigator)",
  ...
  },
  {
    ...
    keyContacts: [
      "Dr. Jennifer Krause, PhD (Principal Scientist)",
      "Markus Lindqvist (VP Clinical Systems)",
    ],
    activeTrials: [
...
export const INITIAL_PUBLICATIONS: Publication[] = [
  ...
  },
  {
    ...
    highlight:
      "Area Under the ROC Curve (AUROC) of 0.89 with clinician-verified attribution paths.",
  ...
  },
  {
    id: "pub-5",
    title:
      "Continuous Cuffless Blood Pressure Estimation with Multi-Wavelength Photoplethysmography",
    ...
    highlight:
      "Systolic error standard deviation <= 6.8 mmHg across normotensive and hypertensive cohorts.",
  ...
  },
  {
    ...
    highlight:
      "94.2% top-1 accuracy on rare arrhythmia classification with only 10 annotated patient trajectories.",
...
export const INITIAL_FACILITIES: LabFacility[] = [
  {
    ...
    specs: [
      "4K 120fps Chromatic Sensors",
      "Calibrated Lux Chamber (0-2000 lx)",
      "Synchronized Medical ECG/PPG Baseline",
    ],
    status: "Operational",
    imageUrl:
      "https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&q=80&w=800",
  ...
  },
  {
    ...
    specs: [
      "Sub-mW Power Analyzers",
      "Programmable Motion Artifact Gimbal",
      "Micro-Electrode Skin Interface Bench",
    ],
    status: "Operational",
    imageUrl:
  ...
  },
  {
    ...
    specs: [
      "GPU Inference Blades (48GB VRAM)",
      "Low-Latency Bedside Stream Pipeline (<16ms)",
      "Synthetic EHR Sandbox Isolation",
    ],
    status: "24/7 Compute",
    imageUrl:
  ...
  },
  {
    ...
    specs: [
      "Tissue-Equivalent Polyacrylamide Phantoms",
      "Sparse-Sampling Simulators",
      "3D Deformable Motion Visualizers",
    ],
    status: "Operational",
    imageUrl:
  ...
  },
  {
    ...
    specs: [
      "Acoustic Isolation (<22 dBA ambient)",
      "High-Fidelity Studio Condenser Mics",
      "Binocular 250Hz Infrared Eye Tracker",
    ],
  ...
  },
  {
    ...
    specs: [
      "Dual Bedside High-DPI Monitors",
      "Interactive Saliency Audit Logging",
      "Clinician Usability Latency Profiler",
    ],
...
export const INITIAL_HOMEPAGE: HomepageConfig = {
...
export const INITIAL_RESEARCH: ResearchPillar[] = [
  {
    id: "rppg",
...
export const INITIAL_GALLERY: GalleryItem[] = [
  {
    ...
    caption:
      "Synchronized dual-spectrum RGB and near-infrared camera array with calibrated ambient lux control.",
  ...
  },
  {
    ...
    caption:
      "Fluke Biomedical physiological signal simulator connected to programmable pulsatile fluid phantom.",
    category: "Experimental Setup",
    imageUrl:
  ...
  },
  {
    ...
    caption:
      "Dual 8x NVIDIA A100 node cluster dedicated to training self-supervised bio-signal foundation models.",
    category: "Experimental Setup",
    imageUrl:
  ...
  },
  {
    ...
    caption:
      "Bedside validation in medical intensive care unit with simultaneous multi-lead ECG and invasive catheter lines.",
  ...
  },
  {
    ...
    caption:
      "Prof. Patel presenting real-time contactless blood pressure benchmarks to the international informatics community.",
    category: "Conference",
    imageUrl:
...
function readJsonFile<T>(filePath: string, fallback: T): T {
  try {
    ...
    console.warn(`[NodeJS DataStore] Error reading ${filePath}, falling back:`, err);
    return fallback;
  }
}
...
function writeJsonFile<T>(filePath: string, data: T): void {
  try {
    ...
    console.error(`[NodeJS DataStore] Error saving ${filePath}:`, err);
    throw err;
  }
}
...
export function sortNewsReverseChronological(items: LabNewsItem[]): LabNewsItem[] {
...
export function sortCollaborators(items: Collaborator[]): Collaborator[] {
...
export function sortFacilities(facilities: LabFacility[]): LabFacility[] {
  return [...facilities].sort((a, b) => (a.orderIndex ?? 999) - (b.orderIndex ?? 999));
}

// ----------------------------------------------------
// ENTITY GETTERS & SAVERS
// ----------------------------------------------------

export function getNewsData(): LabNewsItem[] {
  return readJsonFile<LabNewsItem[]>(NEWS_FILE, INITIAL_NEWS);
}
export function saveNewsData(items: LabNewsItem[]): void {
  writeJsonFile(NEWS_FILE, items);
}

export function getTeamData(): TeamMember[] {
  return readJsonFile<TeamMember[]>(TEAM_FILE, INITIAL_TEAM);
}
export function saveTeamData(data: TeamMember[]): void {
  writeJsonFile(TEAM_FILE, data);
}

export function getCollaboratorsData(): Collaborator[] {
  return readJsonFile<Collaborator[]>(COLLABORATORS_FILE, INITIAL_COLLABORATORS);
}
export function saveCollaboratorsData(collaborators: Collaborator[]): void {
  writeJsonFile(COLLABORATORS_FILE, collaborators);
}

export function getPublicationsData(): Publication[] {
  return readJsonFile<Publication[]>(PUBLICATIONS_FILE, INITIAL_PUBLICATIONS);
}
export function savePublicationsData(pubs: Publication[]): void {
  writeJsonFile(PUBLICATIONS_FILE, pubs);
}

export function getFacilitiesData(): LabFacility[] {
  return readJsonFile<LabFacility[]>(FACILITIES_FILE, INITIAL_FACILITIES);
}
export function saveFacilitiesData(facilities: LabFacility[]): void {
  writeJsonFile(FACILITIES_FILE, facilities);
}

export function getInquiriesData(): ContactInquiry[] {
  return readJsonFile<ContactInquiry[]>(INQUIRIES_FILE, []);
}
export function saveInquiriesData(inquiries: ContactInquiry[]): void {
