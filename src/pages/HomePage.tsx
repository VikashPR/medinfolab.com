...
export const HomePage: React.FC<HomePageProps> = ({ onOpenCollab }) => {
  return (
    <div className="space-y-0">
      {/* Hero Section with Live Telemetry & Signal Monitor */}
      <Hero onOpenCollab={onOpenCollab} />

      {/* Research Thrusts & Translational Focus */}
      <ResearchSection onOpenCollab={onOpenCollab} />

      {/* Facilities Preview Section (Concise with "Explore All Facilities" CTA) */}
      <FacilitiesPreview />

      {/* Selected Publications Preview (Concise with "View All Publications" CTA) */}
      <PublicationsPreview />

      {/* News & Announcements Preview (Concise with "View All News" CTA) */}
      <NewsPreview />

      {/* Team & Investigators with Smooth Slide Animation */}
      <TeamSection />

      {/* Connect & Collaborate Callout Banner */}
      <section className="py-16 bg-white dark:bg-[#120609] border-t border-slate-200 dark:border-slate-800 transition-colors">
