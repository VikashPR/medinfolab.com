            ...
            <div className="p-6 rounded-3xl bg-white dark:bg-[#16070c] border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
              ...
              <div className="space-y-2.5 text-xs text-slate-600 dark:text-slate-300">
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <strong className="text-slate-900 dark:text-white block">Medical Sciences Complex, Wing D</strong>
                    <span>Room 412–418, 500 Biomedical Way, Cambridge, MA 02138</span>
                  </div>
                </div>

                <div className="flex items-center gap-2.5">
                  <Mail className="w-4 h-4 text-maroon-700 dark:text-maroon-400 shrink-0" />
                  <a href="mailto:contact@mindh-lab.org" className="hover:text-maroon-800 dark:hover:text-maroon-400 transition-colors">
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <span>Lab Office Hours: Mon–Fri, 9:00 AM – 5:30 PM EST</span>
                </div>
              </div>
            </div>
